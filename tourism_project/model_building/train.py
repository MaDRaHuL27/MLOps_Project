...
# Same feature lists used in prep.py
numeric_features = [
...
# Set the class weight to handle class imbalance (~4:1 non-buyers to buyers)
...
with mlflow.start_run():
    ...
    # scoring="recall" is used because, from a marketing/business perspective,
    # missing a genuine buyer (false negative) is costlier than a wasted pitch
    # to a non-buyer (false positive)
